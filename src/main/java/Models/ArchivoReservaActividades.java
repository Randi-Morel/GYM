...
public class ArchivoReservaActividades {
    private static final String RUTA_ARCHIVO = "src/main/java/Models/reservaActividades.txt";
    
    public void guardarOEditarPorID(String nuevaLinea, String idBuscado) {
        File archivoOriginal = new File(RUTA_ARCHIVO);
        File archivoTemporal = new File("src/main/java/Models/temp_reservaActividades.txt");
