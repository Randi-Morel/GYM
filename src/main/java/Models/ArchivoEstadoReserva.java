...
public class ArchivoEstadoReserva {
    private static final String RUTA_ARCHIVO = "src/main/java/Models/estadoReserva.txt";
    
    public void guardarOEditarPorID(String nuevaLinea, String idBuscado) {
        File archivoOriginal = new File(RUTA_ARCHIVO);
        File archivoTemporal = new File("src/main/java/Models/temp_estadoReserva.txt");
    ...
    public void eliminarPorID(String idEliminar) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(archivoOriginal));
            ...
            System.out.println("Error al eliminar estado de reserva: " + e.getMessage());
            return;
        }
    ...
    public String buscarPorID(String idBuscado) {
        try (BufferedReader br = new BufferedReader(new FileReader(RUTA_ARCHIVO))) {
            ...
            System.out.println("❌ Error al buscar estado de reserva: " + e.getMessage());
        }
        return null;
    }
}
