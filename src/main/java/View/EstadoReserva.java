...
public class EstadoReserva extends javax.swing.JPanel {

    public EstadoReserva() {
        initComponents();
    }
    
    public javax.swing.JTextField getTID_EstadoReserva() { return TID_EstadoReserva; }
    public javax.swing.JComboBox<String> getC_Estado() { return C_Estado; }
    ...
    private void initComponents() {
        ...
        TID_EstadoReserva = new javax.swing.JTextField();
        ...
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 20, -1, -1));

        TID_EstadoReserva.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
        bg.add(TID_EstadoReserva, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 200, 230, 30));

        jLabel2.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jLabel2.setText("*ID_Estado:");
        bg.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, -1, -1));

        jLabel3.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jLabel3.setText("*Estado:");
        bg.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 170, -1, -1));
        ...
        bg.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, 230, 10));

        jSeparator5.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 230, 230, 10));
        ...
        C_Estado.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
        C_Estado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Activo", "Inactico" }));
        bg.add(C_Estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 200, 230, 30));
    ...
    private javax.swing.JTextField TID_EstadoReserva;
