...
public class ConsultasSalas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        GRD.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre Sala", "Descripción Sala", "Localización "
            }
        ) {
        ...
        C_Filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nombre de Sala", "Descripcion de Sala", "Localización" }));
