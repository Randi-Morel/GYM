...
public class ConsultasUsuarios extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        C_Filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Usuario", "Nombre", "Apellido", "Correo" }));
        ...
        label_Limpiar.getAccessibleContext().setAccessibleName("Limpiar");
