...
public class ConsultasClientes extends javax.swing.JPanel {
    ...
    public javax.swing.JCheckBox getCHK_BalancePendiente() { return CHK_BalancePendiente; }
    ...
    private void initComponents() {
        ...
        CHK_BalancePendiente = new javax.swing.JCheckBox();
        ...
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 0, -1, -1));

        T_Buscar.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
        bg.add(T_Buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 270, 30));

        jLabel2.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jLabel2.setText("Buscar:");
        jLabel2.setToolTipText("");
        bg.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1, -1));
        ...
        bg.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 270, 10));
        ...
        GRD.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellidos", "Fecha de nacimiento", "Fecha de ingreso", "Telefono", "Celular", "Dirección", "Correo", "Balance", "Valor de Cuota", "Estado del cliente", "Tipo de Cliente"
            }
        ) {
        ...
        bg.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 80, -1, -1));

        jSeparator8.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 140, 170, 10));

        C_Filtro.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
        C_Filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nombre", "Apellidos", "Fecha de Nacimiento", "Fecha de Ingreso", "Telefono", "Celular", "Direccion", "Correo", "Balance", "Valor de Cuota", "Estado del Cliente ", "Tipo de Cliente" }));
        C_Filtro.setToolTipText("");
        bg.add(C_Filtro, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 110, 170, 30));
        ...
        bg.add(panel_Limpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 100, 150, -1));

        CHK_BalancePendiente.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        CHK_BalancePendiente.setText("<html>Clientes con<br/>Balance pendiente</html>");
        bg.add(CHK_BalancePendiente, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 100, -1, -1));
    ...
    private javax.swing.JCheckBox CHK_BalancePendiente;
