...
public class ConsultasHorarioActividades extends javax.swing.JPanel {

    public ConsultasHorarioActividades() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Horario de Actividades:");
        jLabel1.setToolTipText("");
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 0, -1, -1));
        ...
        C_Filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Día", "Hora", "Actividad" }));
