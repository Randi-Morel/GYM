...
public class Reserva extends javax.swing.JPanel {
    ...
    public javax.swing.JTextField getTID_Reserva() { return TID_Reserva; }
    public com.toedter.calendar.JDateChooser getD_FechaReserva() { return D_FechaReserva; }
    public javax.swing.JComboBox<String> getCID_Sala() { return CID_Sala; }
    ...
    private void initComponents() {
        ...
        TID_Reserva = new javax.swing.JTextField();
        ...
        CID_Sala = new javax.swing.JComboBox<>();
        ...
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, -1, -1));

        TID_Reserva.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
        bg.add(TID_Reserva, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 230, 30));
        ...
        CID_Sala.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
        bg.add(CID_Sala, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 260, 230, 30));
    ...
    private javax.swing.JComboBox<String> CID_Sala;
    private com.toedter.calendar.JDateChooser D_FechaReserva;
    private javax.swing.JTextField TID_Reserva;
