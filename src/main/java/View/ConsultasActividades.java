...
public class ConsultasActividades extends javax.swing.JPanel {

    public ConsultasActividades() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        GRD.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre Adtividad", "Descripción Actividad", "Localización ", "Entrenador"
            }
        ) {
        ...
        C_Filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nombre de Actividad", "Descripcion de Actividad", "Localización", "Entrenador" }));
