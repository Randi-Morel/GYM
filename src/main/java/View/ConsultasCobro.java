...
public class ConsultasCobro extends javax.swing.JPanel {

    public ConsultasCobro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Cobros:");
        ...
        GRD.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fecha de Cobro", "Cliente", "Valor de Cobro", "Estado"
            }
        ) {
        ...
        C_Filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Cliente", "Valor de Cobro", "Concepto", "Estado" }));
